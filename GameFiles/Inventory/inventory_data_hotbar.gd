...
func drop_slot_data(grabbed_slot_data: SlotData, index: int) -> SlotData:
	# Check if the item data associated with the grabbed slot is an instance of ItemDataTool or ItemDataConsumable.
	if not grabbed_slot_data.item_data is ItemDataTool and not grabbed_slot_data.item_data is ItemDataConsumable:
...
func use_slot_data(index: int) -> void:
	...
	if slot_data.item_data is ItemDataTool:
		print(slot_data.item_data.name)
		print("you set a tool you fool!")
